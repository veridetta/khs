...
<!-- membuat modal untuk ubah data tahun ajaran -->
...
<!-- membuat modal tambah data tahun ajaran -->
                ...
                $('.editUser').click(function() {
                   ...
                   //var id
                     var ids= dtrow.find('td:eq(1)').text();
                        var tahun_ajaran = dtrow.find('td:eq(2)').text();
